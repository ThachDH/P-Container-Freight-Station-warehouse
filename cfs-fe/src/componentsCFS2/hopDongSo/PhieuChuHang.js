...
class PhieuChuHang extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      dataTable: [
        { id: 1, RowID: '1', Code: 'KH-SG-01', Name: 'Khách hàng loại 1' },
        { id: 2, RowID: '2', Code: 'KH-SG-02', Name: 'Khách hàng loại 2' },
        { id: 3, RowID: '3', Code: 'KH-SG-03', Name: 'Khách hàng loại 3' },
      ],
      selected: null,
      // --------- alert state -------
      alert: {
    ...
    this.columns = [
      ...
      { field: "Code", headerName: "Mã Khách Hàng", width: 180 },
      { field: "Name", headerName: "Tên Khách Hàng", width: 290 },
    ];
  }
        ...
        <Card sx={{
          ...
          <CardContent>
            <Stack direction="row" spacing={2} justifyContent={"space-between"} alignItems="center">
              <Typography variant="h5">Chọn Chủ Hàng</Typography>
              <TextField
                id="tim-kiem"
                label="Tìm kiếm"
