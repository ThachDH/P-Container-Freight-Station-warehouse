...
class PhieuKho extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      dataTable: [
        { id: 1, RowID: '1', Code: 'CFS1', Name: 'Kho CFS 1' },
        { id: 2, RowID: '2', Code: 'CFS2', Name: 'Kho CFS 2' },
        { id: 3, RowID: '3', Code: 'CFS3', Name: 'Kho CFS 3' },
        { id: 4, RowID: '4', Code: 'CFS4', Name: 'Kho CFS 4' },
        { id: 5, RowID: '5', Code: 'CFS5', Name: 'Kho CFS 5' },
      ],
      selected: null,
      // --------- alert state -------
      alert: {
    ...
    this.columns = [
      ...
      { field: "Code", headerName: "Mã Kho", width: 180 },
      { field: "Name", headerName: "Tên Kho", width: 290 },
    ];
  }
