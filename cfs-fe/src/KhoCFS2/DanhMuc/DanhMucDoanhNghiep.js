...
class DanhMucDoanhNghiep extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      breadcrumbs: [
        ...
        {
          text: "DM Doanh Nghiệp",
          href: "/category/bus-directory",
        },
      ],
      page: 0,
      rowsPerPage: 10,
      ...
      dataTable: [
        { id: 1, STT: 1, ENTERPRISE_CODE: "TEST1", ENTERPRISE_NAME: "TEST1", ADDRESS: "Hồ Chí Minh", VAT: "989", EMAIL: "hanguyen25102@gmail.com" },
        { id: 2, STT: 2, ENTERPRISE_CODE: "TEST2", ENTERPRISE_NAME: "TEST2", ADDRESS: "Hồ Chí Minh", VAT: "789", EMAIL: "minhnguyen25102@gmail.com" },
        { id: 3, STT: 3, ENTERPRISE_CODE: "TEST3", ENTERPRISE_NAME: "TEST3", ADDRESS: "Hồ Chí Minh", VAT: "929", EMAIL: "khanguyen25102@gmail.com", status: "delete" },
      ],
      data: {
        ENTERPRISE_CODE: "",
        ENTERPRISE_NAME: "",
  ...
  render() {
    return (
      <Box>
        <FixedPageName
          pageName="Danh Mục Doanh Nghiệp"
...
export default DanhMucDoanhNghiep;