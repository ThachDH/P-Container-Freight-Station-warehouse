...
class LoaiVanChuyen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      breadcrumbs: [
    ...
    this.columns = [
      ...
      {
        field: "No", headerName: "Mã Loại Hình Vận Chuyển",
        editable: true,
        minWidth: 600,
      },
      {
        field: "Name",
        headerName: "Tên Loại Hình Vận Chuyển",
        editable: true,
        minWidth: 600
      },
    ];
